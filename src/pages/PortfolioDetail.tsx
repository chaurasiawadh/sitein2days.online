            ...
            <div className="pt-8 pb-16 sm:pt-16 sm:pb-20">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 sm:mb-12">
                        ...
                        {(study.playStoreLink || study.appStoreLink || study.websiteLink) && (
                            <div className="flex flex-wrap gap-4 shrink-0">
                                ...
                                {study.appStoreLink && (
                                    <a href={study.appStoreLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-black text-white px-6 py-2.5 rounded-xl font-bold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                                        <Smartphone size={20} />
                                ...
                                {study.playStoreLink && (
                                    <a href={study.playStoreLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-white text-black border border-gray-200 px-6 py-2.5 rounded-xl font-bold hover:border-black transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                                        <Download size={20} />
                                        <div className="text-left leading-tight">
                ...
                <div className="px-4 max-w-7xl mx-auto mb-12 sm:mb-20">
                    <div className="aspect-video bg-gray-100 rounded-[2rem] overflow-hidden shadow-2xl">
                        <img src={study.image} alt={study.client} loading="lazy" className="w-full h-full object-cover" />
                    </div>
                </div>
                ...
                <div className="px-4 max-w-7xl mx-auto grid gap-12 sm:gap-24">
                                    ...
                                    <div className="space-y-6 font-mono text-sm">
                                        {study.techStack.frontend && (
                                            <div className="flex flex-col sm:flex-row sm:justify-between border-b border-gray-100 pb-3 gap-1 sm:gap-4">
                                                <span className="text-gray-400 uppercase text-[10px] font-bold tracking-widest">Frontend</span>
                                        ...
                                        {study.techStack.backend && (
                                            <div className="flex flex-col sm:flex-row sm:justify-between border-b border-gray-100 pb-3 gap-1 sm:gap-4">
                                                <span className="text-gray-400 uppercase text-[10px] font-bold tracking-widest">Backend</span>
                                        ...
                                        {study.techStack.integrations && (
                                            <div className="flex flex-col sm:flex-row sm:justify-between border-b border-gray-100 pb-3 gap-1 sm:gap-4">
                                                <span className="text-gray-400 uppercase text-[10px] font-bold tracking-widest">Integrations</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        <div className="bg-gray-50 p-10 rounded-[2.5rem]">
                            ...
                            <p className="text-gray-700 leading-relaxed text-lg font-medium">{study.buildTimeline}</p>
                        </div>
                        <div className="bg-gray-50 p-10 rounded-[2.5rem]">
                            <h3 className="text-2xl font-black mb-6 flex items-center gap-3"><Users className="text-black" /> Resources Strategy</h3>
                            <p className="text-gray-700 leading-relaxed text-lg font-medium">{study.resourcesNeeded}</p>
                        </div>
                    </div>
