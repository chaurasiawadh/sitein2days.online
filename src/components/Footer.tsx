                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link to="/services" className="text-gray-600 text-sm hover:text-black transition-colors">Services</Link></li>
                            <li><Link to="/faq" className="text-gray-600 text-sm hover:text-black transition-colors">FAQ</Link></li>
                            <li><Link to="/portfolio" className="text-gray-600 text-sm hover:text-black transition-colors">Portfolio</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link to="/contact" className="text-gray-600 text-sm hover:text-black transition-colors">Get in Touch</Link></li>
                            <li><Link to="/services" className="text-gray-600 text-sm hover:text-black transition-colors">Expertise</Link></li>
                        </ul>
                    </div>
